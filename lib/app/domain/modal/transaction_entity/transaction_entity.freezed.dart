...
class _$TransactionEntityImpl implements _TransactionEntity {
  ...
  @override
  String toString() {
    return 'TransactionEntity(id: $id, name: $name, amount: $amount, type: $type, category: $category, date: $date)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, amount, type, category, date);
...
abstract class _TransactionEntity implements TransactionEntity {
  const factory _TransactionEntity(
      ...
      required final DateTime date}) = _$TransactionEntityImpl;
